...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Wed Aug 8 17:36:26 2018
# Project:  1337-qt.pro
# Template: app
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/user/LAB/1337/src/leveldb/libleveldb.a /home/user/LAB/1337/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/user/LAB/1337/src/leveldb/libleveldb.a; cd /home/user/LAB/1337/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/user/LAB/1337/src/leveldb/libleveldb.a: FORCE
	cd /home/user/LAB/1337/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/user/LAB/1337/build/build.h: FORCE
	cd /home/user/LAB/1337; /bin/sh share/genbuild.sh /home/user/LAB/1337/build/build.h
