...
static const char qt_meta_stringdata_MultiSendDialog[] = {
    "MultiSendDialog\0\0on_viewButton_clicked()\0"
...
const QMetaObjectExtraData MultiSendDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MultiSendDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MultiSendDialog,
      qt_meta_data_MultiSendDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MultiSendDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MultiSendDialog))
